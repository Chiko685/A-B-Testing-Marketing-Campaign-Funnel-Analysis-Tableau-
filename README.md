# A/B Testing: Marketing Campaign & Funnel Analysis (Tableau)

## 📌 Project Overview
This project evaluates the effectiveness of two distinct marketing strategies (Control Campaign A vs. Test Campaign B) using A/B testing methodology. The analysis focuses on conversion funnel performance and cost efficiency to determine which strategy yields the highest ROI for the business.
